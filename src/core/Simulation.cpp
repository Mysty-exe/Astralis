...
void Simulation::applyForces(double timeStep, int timeRate)
{
...
void Simulation::display(Vector panningOffset, int timeRate, double timeStep)
{
    for (CelestialObject &obj : objects)
    {
        if (obj.toggleParticles)
        {
            obj.particles.renderParticles(renderer, obj.objType, obj.position.x + (obj.particlePos.x * obj.radius), obj.position.y + (obj.particlePos.y * obj.radius), panningOffset, obj.particlePos * obj.radius, obj.particleExplosion, timeStep, obj.particleDurationTimer.isStarted());
        ...
        {
            obj.particles.renderParticles(renderer, obj.objType, obj.position.x, obj.position.y, panningOffset, obj.velocity * -1, obj.particleExplosion, timeStep, true);
        }
...
void Simulation::displayTimeRate(int rate)
{
...
void Simulation::displaySimulationDate(int rate, int height)
{
...
void Simulation::displayObjectInfo(CelestialObject obj, int x, int y, int timeRate)
{
