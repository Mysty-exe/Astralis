...
LDFLAGS = -L./libs/SDL2/lib -L./libs/SDL2Image/lib -L./libs/SDL2TTF/lib -L./libs/SDL2Mixer/lib icon.o -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lSDL2_ttf -lSDL2_mixer
...
# Run the game
run: $(TARGET)
	@taskkill /F /IM Astralis.exe 2>nul || exit 0
	@echo Running Astralis...
	@./$(TARGET)
