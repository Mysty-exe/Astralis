...
private:
    ...
    Image newSimulationTxt, loadSimulationTxt, noPastSimsTxt, newTxt, controlsHeaderTxt, controlsTxt, templateTxt, editIcon, editHoverIcon, binIcon, binHoverIcon;
    ...
    Sidebar sidebar;
    SDL_Rect editingRect, renderQuad;
